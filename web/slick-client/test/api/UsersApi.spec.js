...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SlickClient.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    describe('getCurrentUserInfo', function() {
      it('should call getCurrentUserInfo successfully', function(done) {
        ...
        //instance.getCurrentUserInfo(pet, function(error) {
    ...
    describe('getUserInfo', function() {
      it('should call getUserInfo successfully', function(done) {
        ...
        //instance.getUserInfo(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getUsersForCompany', function() {
      it('should call getUsersForCompany successfully', function(done) {
        //uncomment below and update the code to test getUsersForCompany
        //instance.getUsersForCompany(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
