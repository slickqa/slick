...
func (dst *FileUploadInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FileUploadInfo.Merge(dst, src)
}
...
func (dst *LinkListIdentity) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LinkListIdentity.Merge(dst, src)
}
...
func (dst *LinkList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LinkList.Merge(dst, src)
}
...
func (dst *LinkIdentity) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LinkIdentity.Merge(dst, src)
}
...
func (dst *SlickFile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SlickFile.Merge(dst, src)
}
